                ...
                <div className="p-8 sm:p-10 rounded-3xl bg-white border border-slate-200/80 space-y-6">
                  ...
                  <form className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                      <button type="button" onClick={handleSubmit} className='w-full py-4 px-5 rounded-2xl bg-emerald-600 active:scale-[0.99] text-white text-xs font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-2.5'>
